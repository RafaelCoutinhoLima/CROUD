...
# Variáveis globais para armazenar os dados dos treinos
lista_datas = []
lista_tipos = []
lista_duração = []
lista_movimentos = []
...
def exercicio_preferido():
    try:
        ...
        return f"Exercício mais frequente: {selecionado}"
    except Exception as e:
...
def treino_preferido():
    try:
        ...
        return f"Tipo de treino mais frequente: {max(lista_tipos, key=lista_tipos.count)}"
    except Exception as e:
